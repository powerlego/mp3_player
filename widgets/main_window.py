...
class MainWindow(QMainWindow):
    ...
    def create_actions(self):
        ...
        self.import_file_action.setStatusTip(self.tr("Import a MP3 file into the current playlist"))
        ...
        self.import_folder_action.setStatusTip(self.tr("Import a folder of MP3 files into the player"))
        ...
        self.import_playlist_action.setStatusTip(self.tr("Import a playlist into the player"))
